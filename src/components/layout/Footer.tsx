...
const footerLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Terms of Website Use", href: "/website-terms" },
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-between">
          <div className="lg:w-1/3 mb-8 lg:mb-0">
            <h3 className="text-xl font-bold mb-4">AD Fixtures Inc.</h3>
            <div className="flex flex-col space-y-2">
              ...
              >
                ...
                No.68, Jiangong Street, Taiping District Taichung City 411034,
                Taiwan
              </a>
            </div>
          </div>
        ...
        <div className="mt-8 md:mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0 text-sm text-center md:text-left">
              © {currentYear} AD Fixtures Inc. All rights reserved.
            </div>
