...
const _TypographyFont = ['averta', 'inter'] as const;

type TypographyProps<T extends React.ElementType> = {
  /** @default <p> tag */
  as?: T;
  className?: string;
  color?: (typeof _TypographyColor)[number];
  /**
   ...
   * | c2      | -          | 11px      | 400         |
   */
  variant?: (typeof _TypographyVariant)[number];
  font?: (typeof _TypographyFont)[number];
...
const Typography: any = React.forwardRef(
